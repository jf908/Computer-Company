...
{
    private Dictionary<string, DynValue> insertions = new Dictionary<string, DynValue>();

    public CCCommands(Dictionary<string, DynValue> insertions)
    {
    ...
    public DynValue this[string name]
    {
        ...
        set
        {
            ...
            {
                throw new Exception("command override must be a function");
            }
